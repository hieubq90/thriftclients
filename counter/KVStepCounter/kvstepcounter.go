...
type TKVCounter struct {
  ...
  Hvalue int64 `thrift:"hvalue,3" db:"hvalue" json:"hvalue"`
}
...
func (p *TKVCounter) GetHvalue() int64 {
  return p.Hvalue
}
...
func (p *TKVCounter)  ReadField3(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI64(); err != nil {
...
func (p *TKVCounter) writeField3(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("hvalue", thrift.I64, 3); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:hvalue: ", p), err) }
  if err := oprot.WriteI64(int64(p.Hvalue)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.hvalue (3) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 3:hvalue: ", p), err) }
  return err
}
...
func (p *KVStepCounterServiceClient) CreateGenerator(ctx context.Context, genName string) (r int32, err error) {
  ...
  if err = p.Client_().Call(ctx, "createGenerator", &_args18, &_result19); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) RemoveGenerator(ctx context.Context, genName string) (r int32, err error) {
  ...
  if err = p.Client_().Call(ctx, "removeGenerator", &_args20, &_result21); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) GetCurrentValue(ctx context.Context, genName string) (r int64, err error) {
  ...
  if err = p.Client_().Call(ctx, "getCurrentValue", &_args22, &_result23); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) GetValue(ctx context.Context, genName string) (r int64, err error) {
  ...
  if err = p.Client_().Call(ctx, "getValue", &_args24, &_result25); err != nil {
    return
  }
...
func (p *KVStepCounterServiceClient) GetStepValue(ctx context.Context, genName string, step int64) (r int64, err error) {
  ...
  if err = p.Client_().Call(ctx, "getStepValue", &_args26, &_result27); err != nil {
    return
  }
